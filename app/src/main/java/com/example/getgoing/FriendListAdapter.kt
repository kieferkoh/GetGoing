...
class FriendListAdapter(
...
) : RecyclerView.Adapter<FriendListAdapter.CourseViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FriendListAdapter.CourseViewHolder {
    ...
    override fun onBindViewHolder(holder: FriendListAdapter.CourseViewHolder, position: Int) {
